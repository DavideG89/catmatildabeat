...
('Midnight Pulse', 'Cat Matilda Beat', 'Ambient Electronic', 138, 'C minor', '3:15', '/placeholder.svg?height=400&width=400&text=Midnight+Pulse', 'https://beatstars.com/catmatildabeat', 45, 'active', 'trending'),
('Melodic Switch', 'Cat Matilda Beat', 'Alternative HipHop', 95, 'G major', '3:45', '/placeholder.svg?height=400&width=400&text=Melodic+Switch', 'https://beatstars.com/catmatildabeat', 38, 'active', 'trending'),
('Drill Energy', 'Cat Matilda Beat', 'Rap', 150, 'F# minor', '2:58', '/placeholder.svg?height=400&width=400&text=Drill+Energy', 'https://beatstars.com/catmatildabeat', 52, 'active', 'trending'),
...
('Evening Glow', 'Cat Matilda Beat', 'Ambient', 85, 'D major', '4:12', '/placeholder.svg?height=400&width=400&text=Evening+Glow', 'https://beatstars.com/catmatildabeat', 67, 'active', 'featured'),
('Pop Anthem', 'Cat Matilda Beat', 'Rock', 128, 'C major', '3:28', '/placeholder.svg?height=400&width=400&text=Pop+Anthem', 'https://beatstars.com/catmatildabeat', 89, 'active', 'featured'),
('Groove Fusion', 'Cat Matilda Beat', 'Funk', 110, 'A minor', '3:52', '/placeholder.svg?height=400&width=400&text=Groove+Fusion', 'https://beatstars.com/catmatildabeat', 34, 'active', 'featured'),
...
('Future Bass Drop', 'Cat Matilda Beat', 'Electronic', 150, 'E minor', '3:33', '/placeholder.svg?height=400&width=400&text=Future+Bass+Drop', 'https://beatstars.com/catmatildabeat', 12, 'active', 'new_releases'),
('Lo-Fi Dreams', 'Cat Matilda Beat', 'Lo-Fi', 70, 'F major', '4:05', '/placeholder.svg?height=400&width=400&text=Lo-Fi+Dreams', 'https://beatstars.com/catmatildabeat', 28, 'active', 'new_releases'),
('Retro Runner', 'Cat Matilda Beat', 'Synthwave', 145, 'B minor', '2:47', '/placeholder.svg?height=400&width=400&text=Retro+Runner', 'https://beatstars.com/catmatildabeat', 19, 'active', 'new_releases'),
...
('Ambient Trails', 'Cat Matilda Beat', 'Ambient', 135, 'A# minor', '3:21', '/placeholder.svg?height=400&width=400&text=Ambient+Trails', 'https://beatstars.com/catmatildabeat', 8, 'active', 'latest'),
('Golden Era', 'Cat Matilda Beat', 'Boom Bap / Old school', 90, 'Bb major', '3:58', '/placeholder.svg?height=400&width=400&text=Golden+Era', 'https://beatstars.com/catmatildabeat', 15, 'active', 'latest'),
('Synthwave Retro', 'Cat Matilda Beat', 'Synthwave', 120, 'C# minor', '4:15', '/placeholder.svg?height=400&width=400&text=Synthwave+Retro', 'https://beatstars.com/catmatildabeat', 22, 'active', 'latest'),
('Gospel Glow', 'Cat Matilda Beat', 'Cinematic Emotional', 140, 'G minor', '3:42', '/placeholder.svg?height=400&width=400&text=Gospel+Glow', 'https://beatstars.com/catmatildabeat', 31, 'active', 'latest'),
('Boom Bap Classic', 'Cat Matilda Beat', 'Boom Bap / Old school', 95, 'D minor', '3:18', '/placeholder.svg?height=400&width=400&text=Boom+Bap+Classic', 'https://beatstars.com/catmatildabeat', 26, 'active', 'latest'),
('Indie Breeze', 'Cat Matilda Beat', 'Indie', 95, 'E major', '3:35', '/placeholder.svg?height=400&width=400&text=Indie+Breeze', 'https://beatstars.com/catmatildabeat', 41, 'active', 'latest');
