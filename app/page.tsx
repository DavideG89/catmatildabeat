...
export default function Home() {
  ...
  return (
    <main className="flex flex-col min-h-screen overflow-x-hidden bg-background">
      {/* Hero Section */}
      <section
        id="hero-section"
...
<section className="py-10 md:py-16">
        ...
        <div className="container mx-auto px-4">
          <Tabs defaultValue="new" className="w-full">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
              ...
              <TabsTrigger
                  value="new"
                  className="border-red-500/30 text-black data-[state=active]:bg-brand-600 data-[state=active]:text-white text-xs md:text-sm py-2 px-4"
                >
                  New Releases
                </TabsTrigger>
                <TabsTrigger
   ...
   <section className="py-8 md:py-16">
      ...
      {/* CTA Section */}
      <section className="py-12 md:py-20 text-foreground">
        <div className="container mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <Button
              size="lg"
              variant="tertiary"
              className="text-brand-500 md:text-lg px-5 md:px-7"
